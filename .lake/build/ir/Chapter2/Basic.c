...
// Module: Chapter2.Basic
// Imports: Init Mathlib.Tactic Mathlib.Algebra.Group.Basic Mathlib.Algebra.Group.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Chapter2_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
